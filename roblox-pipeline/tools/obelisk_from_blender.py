...
# --- skulls: REMOVED 2026-09-12 (Justin: "you can't see them, they are just bad
# lighting"). At x2 scale, against a charcoal shaft under a warm wash, a bone-cream
# sphere read as a smudge rather than a skull. The four recesses they sat in are left
# as bare stone; if skulls come back they want to be lit from their own side, not
# borrowed from the shaft glow.
...
-- reeds, waves — nothing written) and an
-- HW-002 fire jet on the cap instead of the draft's gold cone. No skulls: see below. THE OBELISK IS THE BEACON
