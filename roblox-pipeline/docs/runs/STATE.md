...
| Art + sound | **Crafting bench in the pack as data** (`server/bench.luau`, 82 parts, from Justin's Blender drop; set dressing, unsynced). Grey-box with the lighting rig applied from data (default lighting gone). Shelf ready: 15 model IDs + 7 audio IDs (`games/hell-week/shelf.md`). Inserts and recolor are Wave 4, behind the publish (InsertService) | 2026-09-12 |
