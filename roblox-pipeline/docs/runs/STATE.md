...
| Field | Value | Updated |
|---|---|---|
| Shape of the game | **Five worlds, one per pentagram point** (Quiet Shore · Still Wood · Drowned Quarter · Long Salt · Kiln), seven trials each, point dark/red/green. Framework built and wired; only world 1 exists (`games/hell-week/server/biomes.luau`) | 2026-09-12 |
