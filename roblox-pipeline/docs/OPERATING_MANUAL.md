...
|---|---|---|---|---|
| **0 · Kick** | [A] 15 min | Slug. `brief.md` drafted **from the four paragraphs** — never a form to fill. Ledger queried for this context. | — | Name + four paragraphs. Silence on the draft brief = accept. |
